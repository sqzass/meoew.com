...
console.log("Meoew.com v" + app.getVersion());
...
if (!app.requestSingleInstanceLock({ IS_DEV })) {
    if (IS_DEV) {
        console.log("Meoew.com is already running. Quitting previous instance...");
        init();
    } else {
        console.log("Meoew.com is already running. Quitting...");
        app.quit();
    }
} else {
    init();
