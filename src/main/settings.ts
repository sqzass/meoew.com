...
export const Settings = loadSettings<TSettings>(SETTINGS_FILE, "Meoew.com settings", DefaultVesktopSettings);
export const VencordSettings = loadSettings<TVencordSettings>(VENCORD_SETTINGS_FILE, "Vencord settings");
export const State = loadSettings<TState>(STATE_FILE, "Meoew.com state");
